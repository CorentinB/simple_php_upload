	...
	<body>
		...
		<div class="upload_form">
			...
			<form action="uploaded.php" method="post" enctype="multipart/form-data">
	    		<input type="file" class="filestyle" name="monFichier">
	    		<br><br>
	    		<input class="btn btn-success" type="submit" value="Envoyez le fichier !" />
	    		<br />
	    		<br />
	    		<h6 class="alert">Attention, seuls les fichiers jpg, jpeg, gif, bmp et png sont acceptés et ceux-ci ne doivent pas dépasser 2 Mo.</h6>
			</form>
